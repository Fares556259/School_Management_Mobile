...
const translations = {
  ar: {
    ...
    ok2: "حسناً",
    updateProfilePhoto: "تحديث الصورة الشخصية",
    chooseHowToAddPhoto: "اختر طريقة إضافة صورتك الشخصية",
    chooseFromLibrary: "اختيار من المعرض",
    pickFromGallery: "اختر صورة من ألبوم الصور في هاتفك",
    takePhoto: "التقاط صورة",
    useCameraNow: "استخدم كاميرا الهاتف الآن",
    profilePhotoUpdatedSuccess: "تم تحديث الصورة الشخصية بنجاح",
    profileUpdatedSuccess: "تم تحديث الملف الشخصي بنجاح",
    failedToUpdateProfile: "فشل في تحديث الملف الشخصي",
    nameLabel: "الاسم",
    surnameLabel: "اللقب",
    phoneLabel: "رقم الهاتف",
    editChildProfile: "تعديل ملف التلميذ",
    ...
    noDeadline: "بدون تاريخ محدد",
    optional: "اختياري",
    chooseDueDateOptional: "تحديد تاريخ الاستحقاق (اختياري)",
    instructions: "التعليمات",
    noDescription: "لا يوجد وصف.",
    imageFile: "ملف صورة",
    attachWork: "أرفق عملك (اختياري)",
    addPhotos: "إضافة صور",
    addPdfDoc: "إضافة PDF/Doc",
    uploading: "جارٍ التحميل...",
    markAsComplete: "تحديد كمكتمل",
    completedCheck: "مكتمل ✓",
    notifyTeacher: "تحديد هذا كمكتمل سيعلم معلمك.",
    todayDate: "اليوم",
    tomorrowDate: "غدًا",
    ...
    allowPhotoAccess: "يرجى السماح بالوصول إلى الصور لإرفاق العمل.",
    error: "خطأ",
    successAlert: "نجاح! 🎉",
    taskCompletedWellDone: "تم وضع علامة على المهمة كمكتملة. أحسنت!",
    failedToUpdate: "فشل في تحديث حالة المهمة: ",
    taskNotFound: "المهمة غير موجودة أو منتهية الصلاحية.",
    details: "التفاصيل",
    absencesThisMonth: "الغيابات هذا الشهر",
    grade: "الفصل",
    sessionsHistory: "سجل الجلسات",
    detailedSessionData: "ستظهر بيانات الجلسة التفصيلية هنا.",
    schoolContact: "الاتصال بالمدرسة",
    administration: "الإدارة",
    callSchool: "اتصل بالمدرسة",
    officialMessage: "رسالة رسمية",
    announcementInfo: "هذا إعلان مدرسي. لأي أسئلة، يرجى الاتصال بمعلم طفلك عبر علامة تبويب الدورات.",
    viewTask: "عرض المهمة",
    alertWord: "تنبيه",
    ago1d: "منذ يوم",
    ...
    requiredActions: "المطلوب سداده",
    paidHistoryTab: "سجل الدفعات",
    dueInstallmentsTitle: "الأقساط المستحقة",
    paidInstallmentsTitle: "الأقساط المدفوعة",
    noPaidInstallments: "لا توجد وصولات مدفوعة",
    noPaymentsYet: "لم تقم بخلاص أي أقساط بعد.",
    allCaughtUpState: "أنت في السليم!",
    noPendingPayments: "ليس لديك أي أقساط أو مستحقات متأخرة حالياً.",
    ...
    announcementAdmin: "الإدارة",
    officialCommunication: "رسالة رسمية",
    attachedDocument: "وثيقة مرفقة",
    tapToViewPdf: "اضغط لعرض ملف PDF",
  },
  fr: {
    tabHome: "Accueil",
    tabCourses: "Matières",
    ...
    pleaseEnablePushNotificationPermissions: "Veuillez activer les notifications dans les paramètres de votre appareil pour recevoir les alertes.",
    ok: "D'accord",
    notificationsEnabled: "Notifications activées 🔔",
    youWillNowReceiveInstant: "Vous recevrez désormais des alertes instantanées pour les devoirs, les notes et les annonces.",
    ok1: "D'accord",
    notificationsDisabled: "Notifications désactivées",
    pushNotificationsHaveBeenDisabled: "Les notifications instantanées ont été désactivées.",
    ok2: "D'accord",
    updateProfilePhoto: "Modifier la photo de profil",
    chooseHowToAddPhoto: "Choisissez comment ajouter votre photo",
    chooseFromLibrary: "Choisir dans la galerie",
    pickFromGallery: "Sélectionnez depuis votre galerie photo",
    takePhoto: "Prendre une photo",
    useCameraNow: "Utilisez l'appareil photo dès maintenant",
    ...
    editChildProfile: "Modifier le profil de l'enfant",
    ...
    teacherLabel: "Enseignant(e)",
    notDetermined: "Non déterminée",
    noDeadline: "Pas de date limite",
    optional: "Optionnel",
    chooseDueDateOptional: "Définir une date limite (Optionnel)",
    instructions: "Instructions",
    noDescription: "Aucune description fournie.",
    imageFile: "Fichier image",
    attachWork: "Joindre votre travail (Optionnel)",
    addPhotos: "Ajouter des photos",
    addPdfDoc: "Ajouter PDF/Doc",
    uploading: "Téléchargement...",
    markAsComplete: "Marquer comme terminé",
    completedCheck: "Terminé ✓",
    notifyTeacher: "Marquer ceci comme terminé en informera votre professeur.",
    ...
    allowPhotoAccess: "Veuillez autoriser l'accès aux photos pour joindre le travail.",
    error: "Erreur",
    successAlert: "Succès ! 🎉",
    taskCompletedWellDone: "Tâche marquée comme terminée. Bien joué !",
    failedToUpdate: "Échec de la mise à jour du statut : ",
    taskNotFound: "Tâche introuvable ou expirée.",
    details: "Détails",
    absencesThisMonth: "Absences ce mois-ci",
    grade: "Classe",
    sessionsHistory: "HISTORIQUE DES SESSIONS",
    detailedSessionData: "Les données détaillées de la session apparaîtront ici.",
    schoolContact: "CONTACT DE L'ÉCOLE",
    administration: "ADMINISTRATION",
    callSchool: "Appeler l'école",
    officialMessage: "Message officiel",
    announcementInfo: "Il s'agit d'une annonce de l'école. Pour toute question, veuillez contacter le professeur de votre enfant via l'onglet Cours.",
    ...
    paidHistoryTab: "Historique des paiements",
    dueInstallmentsTitle: "Paiements dus",
    paidInstallmentsTitle: "Paiements effectués",
    noPaidInstallments: "Aucun paiement",
    noPaymentsYet: "Vous n'avez effectué aucun paiement pour l'instant.",
    allCaughtUpState: "Tout est à jour !",
    noPendingPayments: "Vous n'avez aucun paiement en attente ou en retard.",
    ...
    tapToViewPdf: "Appuyez pour voir le fichier PDF",
  },
  en: {
    tabHome: "Home",
    tabCourses: "Courses",
    ...
    chooseHowToAddPhoto: "Choose how you'd like to add your photo",
    chooseFromLibrary: "Choose from library",
    pickFromGallery: "Pick from your photo gallery",
    takePhoto: "Take a photo",
    useCameraNow: "Use your camera right now",
    profilePhotoUpdatedSuccess: "Profile picture updated successfully",
    ...
    optional: "Optional",
    chooseDueDateOptional: "Set due date (Optional)",
    instructions: "Instructions",
    noDescription: "No description provided.",
    imageFile: "Image File",
    attachWork: "Attach Your Work (Optional)",
    addPhotos: "Add Photos",
    addPdfDoc: "Add PDF/Doc",
    uploading: "Uploading...",
    markAsComplete: "Mark as Complete",
    completedCheck: "Completed ✓",
    notifyTeacher: "Marking this as complete will notify your teacher.",
    todayDate: "Today",
    ...
    allowPhotoAccess: "Please allow photo access to attach work.",
    error: "Error",
    successAlert: "Success! 🎉",
    taskCompletedWellDone: "Task marked as completed. Well done!",
    ...
    detailedSessionData: "Detailed session data will appear here.",
    schoolContact: "SCHOOL CONTACT",
    administration: "ADMINISTRATION",
    callSchool: "Call School",
    officialMessage: "Official Message",
    announcementInfo: "This is a school announcement. For any questions, please contact your child's teacher via the Courses tab.",
    viewTask: "View Task",
    alertWord: "ALERT",
    ago1d: "1d ago",
    ...
    paidHistoryTab: "Paid History",
    dueInstallmentsTitle: "Due Installments",
    paidInstallmentsTitle: "Paid Installments",
    noPaidInstallments: "No Paid Installments",
    noPaymentsYet: "You haven't made any payments yet.",
    allCaughtUpState: "All Caught Up!",
    noPendingPayments: "You have no pending or overdue payments right now.",
    ...
    tapToViewPdf: "Tap to view PDF file",
  }
};
