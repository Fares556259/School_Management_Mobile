...
const NoteItem = ({ note }: any) => (
  <View style={{ backgroundColor: 'white', padding: 16, borderRadius: 24, marginBottom: 16, borderWidth: 1, borderColor: '#f1f4f6' }}>
    <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
      <View style={{ width: 32, height: 32, borderRadius: 10, backgroundColor: '#eff6ff', alignItems: 'center', justifyContent: 'center', marginRight: 12 }}>
...
export const HomeScreen = ({ navigation }: any) => {
  ...
  const notesByDate: any = {
    '25': [{ id: 1, text: 'Ahmed was very participative today in solving abstract geometry problems.' }]
  };

  const filesByDate: any = {
    '25': [
      { id: 1, name: 'Geometry_Notes.pdf', size: '2.4 MB' },
      { id: 2, name: 'Exercises_Ch3.pdf', size: '1.1 MB' }
    ]
  };
          ...
          {currentNotes.length > 0 && (
            <View style={{ marginBottom: 32 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16 }}>
                ...
                <Text style={{ fontSize: 18, fontWeight: 'bold', color: '#2b3437' }}>Teacher Remarks</Text>
              </View>
          ...
          {currentFiles.length > 0 && (
            <View style={{ marginBottom: 32 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16 }}>
                ...
                <Text style={{ fontSize: 18, fontWeight: 'bold', color: '#2b3437' }}>Course Resources</Text>
              </View>
          ...
          {homeworkGivenTodayByDate[selectedDate]?.length > 0 && (
            <View style={{ marginBottom: 32 }}>
               <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16 }}>
                ...
                <Text style={{ fontSize: 18, fontWeight: 'bold', color: '#2b3437' }}>Tasks Given Today</Text>
              </View>
          ...
          {homeworkDueTodayByDate[selectedDate]?.length > 0 && (
            <View style={{ marginBottom: 32 }}>
               <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16 }}>
                ...
                <Text style={{ fontSize: 18, fontWeight: 'bold', color: '#2b3437' }}>Tasks to Submit Today</Text>
              </View>
