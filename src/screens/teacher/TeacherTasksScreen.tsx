  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f8fafc' }} edges={['top']}>
      ...
      >
        {showAddForm && (
          <View style={{ backgroundColor: 'white', padding: 24, borderRadius: 28, marginBottom: 32, borderWidth: 1, borderColor: '#f1f5f9', shadowColor: '#000', shadowOpacity: 0.03, shadowRadius: 20, elevation: 5 }}>
            ...
            <View style={{ marginBottom: 20 }}>
              ...
              <TextInput 
                style={{ backgroundColor: '#f8fafc', padding: 16, borderRadius: 16, borderWidth: 1, borderColor: '#f1f5f9', fontSize: 16, color: '#1e293b', height: 100 }}
        ...
        {tasks.map(task => (
          <View key={task.id} style={{ backgroundColor: 'white', padding: 20, borderRadius: 28, marginBottom: 16, borderWidth: 1, borderColor: '#f1f5f9', shadowColor: '#000', shadowOpacity: 0.02, shadowRadius: 15, elevation: 2 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 18, fontWeight: '900', color: '#1e293b' }}>{task.title}</Text>
                <Text style={{ fontSize: 14, color: '#64748b', fontWeight: '600', marginTop: 6, lineHeight: 20 }}>{task.description}</Text>
              </View>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 16, paddingTop: 16, borderTopWidth: 1, borderTopColor: '#f1f5f9' }}>
              ...
              <Text style={{ fontSize: 13, color: '#94a3b8', fontWeight: '800', marginLeft: 6 }}>Due: {new Date(task.dueDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</Text>
            </View>
          </View>
        ))}
